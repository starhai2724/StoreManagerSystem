...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="fontend/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="fontend/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="fontend/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <script src="fontend/vendor/metisMenu/metisMenu.min.js"></script>
